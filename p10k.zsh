function prompt_hola() {
  gradient_glow "$host_nombre"
}



# Generated by Powerlevel10k configuration wizard on 2025-12-23 at 17:21 CST.
...
#    vcs                     # git status
  ...
  typeset -g POWERLEVEL9K_IP_CONTENT_EXPANSION='$P9K_IP_INTERFACE %82F$P9K_IP_IP'
